    ...
    <div className="bg-white">
      ...
      <section className="mx-auto max-w-6xl px-5 py-14 sm:px-6 sm:py-16">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 md:grid-cols-3">
          {[
            ...
            <div
              key={s.n}
              className="group relative rounded-2xl border border-slate-100 bg-white p-6 shadow-[0_4px_20px_-8px_rgba(15,23,42,0.10)] transition-transform hover:-translate-y-0.5"
            >
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {talleres.map((t) => (
                <Link key={t.id} href={`/talleres/${t.slug}`} className="group">
                  <div className="h-full rounded-2xl border border-slate-100 bg-white p-5 shadow-[0_4px_20px_-8px_rgba(15,23,42,0.10)] transition-transform hover:-translate-y-0.5 sm:p-6">
      ...
      <section className="border-t border-slate-100">
        <div className="mx-auto grid max-w-6xl gap-5 px-5 py-14 sm:px-6 sm:py-16 lg:grid-cols-2">
          {/* Clientes */}
          <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-[0_4px_20px_-8px_rgba(15,23,42,0.10)] sm:p-7">
